<x-jet-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            Se necessário, você pode sair de todas as outras sessões de navegador em todos os seus dispositivos. Algumas de suas sessões recentes estão listadas abaixo.
        </div>
